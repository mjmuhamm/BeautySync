...
class AccountInfoViewController: UIViewController {
    ...
    private func createExternalAccount(stripeAccountId: String) {
        let json: [String: Any] = ["stripeAccountId" : "\(stripeAccountId)", "account_holder" : "\(self.individualBankingInfo!.externalAccount!.accountHolder)", "account_number": "\(self.individualBankingInfo!.externalAccount!.accountNumber)", "routing_number" : "\(self.individualBankingInfo!.externalAccount!.routingNumber)"]
        ...
        let task = URLSession.shared.dataTask(with: request, completionHandler: { [weak self] (data, response, error) in
            ...
            DispatchQueue.main.async {
                let data : [String:Any] = ["accountType": self.individualBankingInfo!.externalAccount!.accountType, "stripeAccountId" : stripeAccountId, "externalAccountId" : "\(externalAccount)"]
